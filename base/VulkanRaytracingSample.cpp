...
VulkanRaytracingSample::ScratchBuffer VulkanRaytracingSample::createScratchBuffer(VkDeviceSize size)
{
    ...
    memoryAllocateInfo.memoryTypeIndex
        = vkcpp::findMemoryTypeIndex(memoryRequirements.memoryTypeBits, vkcpp::MEMORY_PROPERTY_DEVICE_LOCAL);
...
void VulkanRaytracingSample::createShaderBindingTable(ShaderBindingTable& shaderBindingTable, uint32_t handleCount)
{
    ...
    shaderBindingTable.stridedDeviceAddressRegion
		= getSbtEntryStridedDeviceAddressRegion(shaderBindingTable.m_buffer, handleCount);
    // Map persistent
