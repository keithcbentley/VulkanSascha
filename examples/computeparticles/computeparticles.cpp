...
public:
    ...
    ~VulkanExample()
    {
        if (m_device) {
            ...
            vkDestroyPipeline(m_device, compute.pipeline, nullptr);
    ...
    void buildCommandBuffers()
    {
        ...
        for (int32_t i = 0; i < m_drawCommandBuffers.size(); ++i) {
			...
			commandBuffer.cmdDraw(PARTICLE_COUNT, 1);
    ...
    void buildComputeCommandBuffer()
    {
		...
		commandBuffer.cmdBindComputePipeline(compute.pipeline);
		commandBuffer.cmdBindComputeDescriptorSet(compute.descriptorSet, compute.pipelineLayout);
        commandBuffer.cmdDispatch(PARTICLE_COUNT / 256, 1, 1);
    ...
    void prepareGraphics()
    {
        ...
        VK_CHECK_RESULT(vkCreateDescriptorSetLayout(
			m_device, &descriptorLayout, nullptr, &graphics.descriptorSetLayout));
    ...
    void prepareCompute()
    {
        ...
        std::vector<VkWriteDescriptorSet> computeWriteDescriptorSets = {
            ...
            vks::initializers::writeDescriptorSet(
                ...
                VK_DESCRIPTOR_TYPE_STORAGE_BUFFER,
                0,
                &storageBuffer.m_vkDescriptorBufferInfo),
            // Binding 1 : Uniform buffer
            vks::initializers::writeDescriptorSet(
                compute.descriptorSet,
                VK_DESCRIPTOR_TYPE_UNIFORM_BUFFER,
                1,
                &compute.uniformBuffer.m_vkDescriptorBufferInfo)
        };
        ...
        VK_CHECK_RESULT(vkCreateComputePipelines(m_device, m_vkPipelineCache, 1, &computePipelineCreateInfo, nullptr, &compute.pipeline));
    ...
    void draw()
    {
        ...
        VkSemaphore graphicsWaitSemaphores[]
			= { compute.semaphore, semaphores.m_vkSemaphorePresentComplete };
        VkSemaphore graphicsSignalSemaphores[]
			= { graphics.semaphore, semaphores.m_vkSemaphoreRenderComplete };
		...
		submitInfo2.addWaitSemaphore(
			compute.semaphore, vkcpp::PIPELINE_STAGE_2_VERTEX_INPUT);
		submitInfo2.addWaitSemaphore(
