...
public:
	...
	~VulkanExample()
	{
		if (m_deviceOriginal) {
			...
			vkDestroyPipeline(m_deviceOriginal, pipelines.textured, nullptr);
	...
	void preparePipelines()
	{
		...
		VK_CHECK_RESULT(vkCreateGraphicsPipelines(m_deviceOriginal, m_vkPipelineCache, 1, &pipelineCI, nullptr, &pipelines.textured));
	}
