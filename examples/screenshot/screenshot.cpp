...
public:
    ...
    void loadAssets()
    {
        model.loadFromFile(getAssetPath() + "models/chinesedragon.gltf", m_pVulkanDevice, m_queue, vkglTF::FileLoadingFlags::PreTransformVertices | vkglTF::FileLoadingFlags::PreMultiplyVertexColors | vkglTF::FileLoadingFlags::FlipY);
    }
    ...
    void setupDescriptors()
    {
        ...
        std::vector<VkWriteDescriptorSet> writeDescriptorSets = {
            vks::initializers::writeDescriptorSet(descriptorSet, VK_DESCRIPTOR_TYPE_UNIFORM_BUFFER, 0, &uniformBuffer.m_vkDescriptorBufferInfo), // Binding 0: Vertex shader uniform buffer
        };
    ...
    void saveScreenshot(const char* filename)
    {
        ...
        vkGetPhysicalDeviceFormatProperties(vkcpp::vkPhysicalDevice(), m_swapChain.colorFormat, &formatProps);
        ...
        // Check if the m_vkDevice supports blitting to linear images
         vkGetPhysicalDeviceFormatProperties(vkcpp::vkPhysicalDevice(), VK_FORMAT_R8G8B8A8_UNORM, &formatProps);
        ...
        VkImage srcImage = m_swapChain.images[m_currentBufferIndex];
        ...
        VkImage dstImage;
        VK_CHECK_RESULT(vkCreateImage(m_device, &imageCreateCI, nullptr, &dstImage));
        ...
        m_pVulkanDevice->flushCommandBuffer(copyCmd, m_queue);
