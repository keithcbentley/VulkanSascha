...
public:
	...
	*/
	void createShaderBindingTable() {
		...
		VK_CHECK_RESULT(m_pVulkanDevice->createBuffer(bufferUsageFlags, memoryUsageFlags, &raygenShaderBindingTable, handleSize));
		VK_CHECK_RESULT(m_pVulkanDevice->createBuffer(bufferUsageFlags, memoryUsageFlags, &missShaderBindingTable, handleSize));
		VK_CHECK_RESULT(m_pVulkanDevice->createBuffer(bufferUsageFlags, memoryUsageFlags, &hitShaderBindingTable, handleSize));
