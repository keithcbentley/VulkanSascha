...
//    PFN_vkCmdPushDescriptorSetKHR vkCmdPushDescriptorSetKHR { VK_NULL_HANDLE };
    ...
    void buildCommandBuffers()
    {
        ...
        for (int32_t i = 0; i < m_drawCommandBuffers.size(); ++i) {
            ...
            for (const auto& cube : cubes) {
                ...
                // Instead of preparing the descriptor sets up-front,
                // using push descriptors we can set (push) them inside of a command buffer
    ...
    void preparePipelines()
    {
        ...
        VkGraphicsPipelineCreateInfo pipelineCI
            = vks::initializers::pipelineCreateInfo(m_vkPipelineLayout, m_renderPassOriginal, 0);
    ...
    void updateCubeUniformBuffers()
    {
        ...
        for (auto& cube : cubes) {
            ...
            memcpy(cube.uniformBuffer.m_pMapped, &cube.modelMat, sizeof(glm::mat4));
        }
